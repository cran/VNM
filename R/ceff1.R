ceff1 <-
function(weight,P,dose,LB,UB,r=10,grid=0.01,epsilon=.001,epsilon_w=10^-6)
{
      t1=P[2]
      t2=-P[4]
      t3=P[4]*log(P[3])
	...
	gr=grid  
     ...
     plot(x1,ds,cex=.1,main="Verify the c-optimal design for ED50",ylab="Sensitivity function",xlab="Dose levels")
